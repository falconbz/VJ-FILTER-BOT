...
API_ID = int(environ.get('API_ID', '28047888'))
API_HASH = environ.get('API_HASH', '8585ef3964cf3c3ff00f067a5ba50c91')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6932912043').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1002618630949'))
...
auth_channel = environ.get('AUTH_CHANNEL', '1002789892211') # give your force subscribe channel id here else leave it blank
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-4685005353').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kgzbbst:bTqc9EK9bBYbTI9L@cluster0.asierqc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movieworldfastnew')
